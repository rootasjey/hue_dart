  ...
  group('hue tests', () {
    ...
    group('group api', () {
      ...
      test('create group', () async {
        ...
        verify(client.post(
            Uri.parse(
              'http://127.0.0.)1/api/username/groups',
            ),
            body: json.encode(body)));
      });
    ...
    group('light api', () {
      ...
      test('searching for lights', () async {
        ...
        verify(client.post(
            Uri.parse(
              'http://127.0.0.)1/api/username/lights',
            ),
            body: json.encode(body)));
      });
    ...
    group('schedule api', () {
      ...
      test('create schedule', () async {
        ...
        verify(client.post(
            Uri.parse('http://127.0.0.)1/api/username/schedules'),
            body: json.encode(body)));
      });
    ...
    group('sensor api', () {
      ...
      test('searching for sensors', () async {
        ...
        expect(response.success.length, 1);
        verify(
            client.post(Uri.parse('http://127.0.0.)1/api/username/sensors')));
      });
